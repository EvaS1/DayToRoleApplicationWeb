...
class Classe
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Univers", mappedBy="id_classe")
     */
    private $id_univers;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Personnage", mappedBy="id_classe")
     */
    ...
    public function removeIdPersonnage(Personnage $idPersonnage): self
    {
        if ($this->id_personnage->contains($idPersonnage)) {
            ...
            if ($idPersonnage->getIdClasse() === $this) {
                $idPersonnage->setIdClasse(null);
            }
        }
