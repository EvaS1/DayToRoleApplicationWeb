 ...
 */
final class Version20200709102805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partie CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE duree duree TIME DEFAULT NULL, CHANGE date_debut date_debut DATETIME DEFAULT NULL, CHANGE date_fin date_fin DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE joueur CHANGE date_inscription date_inscription DATETIME DEFAULT NULL, CHANGE notes notes VARCHAR(255) DEFAULT NULL, CHANGE numero_portable numero_portable VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE joueur CHANGE date_inscription date_inscription DATETIME DEFAULT \'NULL\', CHANGE notes notes VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE numero_portable numero_portable VARCHAR(10) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE partie CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE duree duree TIME DEFAULT \'NULL\', CHANGE date_debut date_debut DATETIME NOT NULL, CHANGE date_fin date_fin DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE scenario CHANGE id_difficulte_id id_difficulte_id INT DEFAULT NULL, CHANGE id_lore_id id_lore_id INT DEFAULT NULL, CHANGE id_campagne_id id_campagne_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE duree duree TIME DEFAULT \'NULL\'');
