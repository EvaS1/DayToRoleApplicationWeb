...
final class Version20200326111822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article_blog (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, nom_url VARCHAR(255) NOT NULL, description_courte VARCHAR(255) NOT NULL, date DATETIME NOT NULL, contenu VARCHAR(3000) NOT NULL, auteur VARCHAR(50) NOT NULL, image VARCHAR(350) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
